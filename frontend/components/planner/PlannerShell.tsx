    ...
    >
      ...
      {plan && summary && (
        <section className="mt-8">
          {/* Summary */}
          <div className="rounded-[var(--am-radius-2xl)] border border-[var(--am-border-light)] bg-[var(--am-bg-elevated)] p-6 shadow-[var(--am-shadow-sm)]">
              ...
              return (
                ...
                >
                  ...
                  <div className="am-progress-track mt-3">
                    <div
                      className="h-full rounded-full bg-[var(--am-success)] transition-all duration-[var(--am-duration-reveal)]"
                    ...
                    {day.tasks.map((task) => (
                      ...
                      >
                        ...
                        <Link
                          ...
                          className="shrink-0 text-xs font-semibold text-[var(--am-primary)] hover:underline"
                        >
                          Study →
                        </Link>
                      </div>
      ...
      {!plan && (
        <section className="mt-8 rounded-[var(--am-radius-2xl)] border border-dashed border-[var(--am-border)] bg-[var(--am-bg-elevated)]/60 p-10 text-center">
