...
export const styles = sortCx({
    common: {
        root: [
            "group relative inline-flex h-max cursor-pointer items-center justify-center whitespace-nowrap outline-[var(--am-primary)] transition duration-100 ease-linear before:absolute focus-visible:outline-2 focus-visible:outline-offset-2",
    ...
    colors: {
        primary: {
            root: [
                "bg-[var(--am-primary)] text-white shadow-sm ring-1 ring-transparent ring-inset hover:bg-[var(--am-primary-hover)] data-loading:bg-[var(--am-primary-hover)]",
        ...
        secondary: {
            root: [
                "border border-[var(--am-border)] bg-[var(--am-surface)] text-[var(--am-text-primary)] shadow-sm hover:bg-[var(--am-warm-bg)] data-loading:bg-[var(--am-warm-bg)]",
                // Icon styles
                "*:data-icon:text-[var(--am-text-secondary)] hover:*:data-icon:text-[var(--am-text-primary)]",
            ].join(" "),
        },
        tertiary: {
            root: [
                "text-[var(--am-text-secondary)] hover:bg-[var(--am-warm-bg)] hover:text-[var(--am-text-primary)] data-loading:bg-[var(--am-warm-bg)]",
                // Icon styles
                "*:data-icon:text-[var(--am-text-muted)] hover:*:data-icon:text-[var(--am-text-primary)]",
            ].join(" "),
        },
        "link-color": {
            root: [
                "justify-normal rounded p-0! text-[var(--am-primary)] hover:text-[var(--am-primary-hover)]",
                // Inner text underline
                "*:data-text:underline *:data-text:decoration-transparent hover:*:data-text:decoration-current",
                // Icon styles
                "*:data-icon:text-[var(--am-primary)] hover:*:data-icon:text-[var(--am-primary-hover)]",
            ].join(" "),
        },
        "link-gray": {
            root: [
                "justify-normal rounded p-0! text-[var(--am-text-secondary)] hover:text-[var(--am-text-primary)]",
                // Inner text underline
                "*:data-text:underline *:data-text:decoration-transparent hover:*:data-text:decoration-current",
                // Icon styles
                "*:data-icon:text-[var(--am-text-muted)] hover:*:data-icon:text-[var(--am-text-primary)]",
        ...
        "primary-destructive": {
            root: [
                "bg-[var(--am-error)] text-white shadow-sm ring-1 ring-transparent outline-[var(--am-error)] ring-inset hover:brightness-90 data-loading:brightness-90",
                // Inner border gradient
                "before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
                // Icon styles
                "*:data-icon:text-white/80 hover:*:data-icon:text-white",
        ...
        "secondary-destructive": {
            root: [
                "border border-[var(--am-error)]/40 bg-[var(--am-surface)] text-[var(--am-error)] shadow-sm outline-[var(--am-error)] hover:bg-[var(--am-error-light)] data-loading:bg-[var(--am-error-light)]",
                // Icon styles
                "*:data-icon:text-[var(--am-error)]",
            ].join(" "),
        },
        "tertiary-destructive": {
            root: [
                "text-[var(--am-error)] outline-[var(--am-error)] hover:bg-[var(--am-error-light)] data-loading:bg-[var(--am-error-light)]",
                // Icon styles
                "*:data-icon:text-[var(--am-error)]",
            ].join(" "),
        },
        "link-destructive": {
            root: [
                "justify-normal rounded p-0! text-[var(--am-error)] outline-[var(--am-error)] hover:brightness-90",
                // Inner text underline
